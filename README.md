...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/0Y76mefi0b)
...
```sh
npx nx serve galactic-energy-bazaar-api
```

To create a production bundle:

```sh
npx nx build galactic-energy-bazaar-api
```

To see all available targets to run for a project, run:

```sh
npx nx show project galactic-energy-bazaar-api
```
